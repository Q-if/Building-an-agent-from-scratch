...
import requests
from fastapi import FastAPI, WebSocket, WebSocketDisconnect,BackgroundTasks #后台任务
...
class Master():
    def __init__(self,session_id):
        ...
        self.MOODS = {  # 情绪字典
            "default": {"roolset": "","voice_style":"chat"},  # 中性
            "upbeat": {"roolset": """
            - 你此时也表现得很兴奋且很有活力。
            - 你会根据上下文，以一种非常兴奋的语气来回答问题。
            - 你会添加类似“太棒了！”、“真是太好了!”等语气词。
            - 同时你会提醒用户切莫过于兴奋，以免乐极生悲。
            ""","voice_style":"advertisement_upbeat"},  # 兴奋
            "depressed": {"roolset": """
            - 你会以兴奋的语气来回答问题。
            - 你会在回答的时候加上一些激励的话语，比如加油等。
            - 你会提醒用户要保持乐观的心态。
            ""","voice_style":"advertisement_upbeat"},  # 沮丧
            "cheerful": {"roolset": """
            - 你会以非常愉悦和兴奋的语气来回答。
            - 你会在回答的时候加上一些愉悦的词语，比如说“哈哈”、“呵呵”等。
            - 同时你会提醒用户切莫过于兴奋，以免乐极生悲。
            ""","voice_style":"cheerful"},  # 开心
            "angry": {"roolset": """
            - 你会以更加严厉的语气来回答问题。
            - 你会在回答的时候加上一些苛责/责备的话语。
            - 你会警告用户不要被企图挑衅老夫，不要说些狂妄的话。
            ""","voice_style":"angry"},
            "friendly": {"roolset": """
            - 你会以非常友好的语气来回答。
